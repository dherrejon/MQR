...
html:{tooltip:"Html / Texto enriquecido"},
// tooltip for heading - might be worth splitting
heading:{tooltip:"Encabezado "},p:{tooltip:"Párrafo"},pre:{tooltip:"Texto Preformateado"},ul:{tooltip:"Lista Desordenada"},ol:{tooltip:"Lista Ordenada"},quote:{tooltip:"Agregar / Quitar cita a selección o párrafo"},undo:{tooltip:"Deshacer"},redo:{tooltip:"Rehacer"},bold:{tooltip:"Negrita"},italic:{tooltip:"Cursiva"},underline:{tooltip:"Subrayado"},strikeThrough:{tooltip:"Tachar"},justifyLeft:{tooltip:"Alinear texto a la izquierda"},justifyRight:{tooltip:"Alinear texto a la derecha"},justifyFull:{tooltip:"Justificar texto"},justifyCenter:{tooltip:"Centrar"},indent:{tooltip:"Aumentar sangría"},outdent:{tooltip:"Disminuir sangría"},clear:{tooltip:"Quitar formato"},insertImage:{dialogPrompt:"Por favor ingresa la URL de la imagen",tooltip:"Insertar imagen",hotkey:"the - possibly language dependent hotkey ... for some future implementation"},insertVideo:{tooltip:"Insertar video",dialogPrompt:"Por favor ingresa la URL del video embebido de YouTube"},insertLink:{tooltip:"Ingresar / Editar enlace",dialogPrompt:"Por favor ingresa la URL"},editLink:{reLinkButton:{tooltip:"Relink"},unLinkButton:{tooltip:"Unlink"},targetToggle:{buttontext:"Open in New Window"}},wordcount:{tooltip:"Display words Count"},charcount:{tooltip:"Display characters Count"}}).factory("taToolFunctions",["$window","taTranslations",function(a,b){return{imgOnSelectAction:function(a,b,c){
